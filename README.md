...
You can see its main view at [homepage](https://books-api-daftcode.herokuapp.com/).
...
``` shell script
curl -d "username=YourUserName&password=YourPassword" -X POST https://books-api-daftcode.herokuapp.com/api/auth/register/
```
Get your JWT token.
``` javascript
