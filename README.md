...
| PATCH       | [api/books/{id}/](https://books-api-dicoding.herokuapp.com/api/books/1)                     | Object {<br> depends fields to update on book entity<br>}                                                                                              | X                                                                                                                                                                                                                                                                | Performs partial or full update on book object with given ID. Returns updated object. | Bearer {token}       |
