...
| PATCH       | [api/books/{id}/](https://books-api-dicoding.herokuapp.com/api/books/1)                     | Object {<br> content: str<br>}                                                                                                                         | X                                                                                                                                                                                                                                                                | Performs partial or full update on book object with given ID. Returns updated object. | Bearer {token}       |
...
You can see its main view [here](https://books-api-dicoding.herokuapp.com/swagger/).

Also you can see Schema for more detail API documentation. You can see its main view [here](https://books-api-dicoding.herokuapp.com/redoc/)
